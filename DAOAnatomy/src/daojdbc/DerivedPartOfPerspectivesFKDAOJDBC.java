...
public final class DerivedPartOfPerspectivesFKDAOJDBC implements DerivedPartOfPerspectivesFKDAO {
    ...
    public DerivedPartOfPerspectivesFKDAOJDBC(DAOFactory daoFactory) {
	...
	/*
	 * (non-Javadoc)
	 *         display(int, int, String, boolean, String, String)
	 *         display(int , int , sortField, boolean , String , String )
	 *     display(int, int, String, boolean, String, String)
	 */
