...
public class MainDAOTestTimedLeafs2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("=========   ----------------------");
        System.out.println("EXECUTING - MainDAOTestTimedLeafs2.java on " + parsed.toString());
        System.out.println("=========   ----------------------");
        System.out.println("");
        ...
        System.out.println("");
        System.out.println("=========   ----------------------");
        System.out.println("DONE      - MainDAOTestTimedLeafs2.java took " + duration / 1000 + " seconds");
        System.out.println("=========   ----------------------");
    }
}
