 ...
 */
public class EditorBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------

    // DAO.
    private static EditorDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(EditorDAO.class);

    // Data.
    private List<Editor> dataList;
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<Editor> getDataList() throws Exception {
        if (dataList == null) {
