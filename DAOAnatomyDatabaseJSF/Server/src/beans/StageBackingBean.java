 ...
 */
public class StageBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------

    // DAO.
    private static StageDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(StageDAO.class);
    
    // Data.
    private List<Stage> dataList;
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<Stage> getDataList() throws Exception {
        if (dataList == null) {
