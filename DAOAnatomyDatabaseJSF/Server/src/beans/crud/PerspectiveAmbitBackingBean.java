 ...
 */
public class PerspectiveAmbitBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------

    // DAO.
    private static PerspectiveAmbitDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(PerspectiveAmbitDAO.class);

    // Data.
    private List<PerspectiveAmbit> dataList;
    ...
    // Constructors -------------------------------------------------------------------------------
    public PerspectiveAmbitBackingBean() {
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<PerspectiveAmbit> getDataList() throws Exception {
        if (dataList == null) {
