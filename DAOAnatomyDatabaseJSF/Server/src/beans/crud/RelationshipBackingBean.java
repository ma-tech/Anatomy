 ...
 */
public class RelationshipBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------

    // DAO.
    private static RelationshipDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(RelationshipDAO.class);
    ...
    // Constructors -------------------------------------------------------------------------------
    public RelationshipBackingBean() {
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<Relationship> getDataList() throws Exception {
        if (dataList == null) {
