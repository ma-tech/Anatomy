 ...
 */
public class ThingBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------
    
    // DAO.
    private static ThingDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(ThingDAO.class);

    // Data.
    private List<Thing> dataList;
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<Thing> getDataList() throws Exception {
        if (dataList == null) {
