...
<body>
  ...
  <h:form id="form">
    ...
    <h1>Anatomy - ANAD_PART_OF_PERSPECTIVES, with FOREIGN KEYS, at STAGE TS02 ONLY, JSON Tree Only</h1>
    ...
    <h:inputText id="searchTerm" 
                 value="#{DerivedPartOfPerspectivesFKTS02BackingBean.searchTerm}" 
                 size="50"
                 maxlength="50" />
    <br />
    <br />
    ...
    <h:commandButton value="Search" 
                     action="#{DerivedPartOfPerspectivesFKTS02BackingBean.pageFirst}">
    </h:commandButton>
                         
    <%--<h:inputHidden binding="#{DerivedPartOfPerspectivesFKTS02BackingBean.text}" 
                   value="#{DerivedPartOfPerspectivesFKTS02BackingBean.textValue}">
    ...
    <h:dataTable value="#{DerivedPartOfPerspectivesFKTS02BackingBean.dataList}" 
                 var="item">
...
<h:outputText value="#{item.fullPathJson}" escape="false"/>
    ...
    <h:commandButton value="first" 
                     action="#{DerivedPartOfPerspectivesFKTS02BackingBean.pageFirst}"
                     disabled="#{DerivedPartOfPerspectivesFKTS02BackingBean.firstRow == 0}" />
                      
    <h:commandButton value="prev" 
                     action="#{DerivedPartOfPerspectivesFKTS02BackingBean.pagePrevious}"
                     disabled="#{DerivedPartOfPerspectivesFKTS02BackingBean.firstRow == 0}" />
    
    <h:commandButton value="next" 
                     action="#{DerivedPartOfPerspectivesFKTS02BackingBean.pageNext}"
                     disabled="#{DerivedPartOfPerspectivesFKTS02BackingBean.firstRow + DerivedPartOfPerspectivesFKTS02BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS02BackingBean.totalRows}" />
                     
    <h:commandButton value="last" 
                     action="#{DerivedPartOfPerspectivesFKTS02BackingBean.pageLast}"
                     disabled="#{DerivedPartOfPerspectivesFKTS02BackingBean.firstRow + DerivedPartOfPerspectivesFKTS02BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS02BackingBean.totalRows}" />
      
    <h:outputText value="Tree No. #{DerivedPartOfPerspectivesFKTS02BackingBean.currentPage} From #{DerivedPartOfPerspectivesFKTS02BackingBean.totalPages} Possible Tree Paths" />
    <br />

    <%-- Cache bean with data list, paging and sorting variables for next request --%>
    <%-- <t:saveState value="#{DerivedPartOfPerspectivesFKTS02BackingBean}" />--%>
