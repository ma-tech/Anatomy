...
<body>
  ...
  <h:form id="form">
    ...
    <h1>Anatomy - ANAD_PART_OF_PERSPECTIVES, with FOREIGN KEYS, at STAGE TS13 ONLY, JSON Tree Only</h1>
    ...
    <h:inputText id="searchTerm" 
                 value="#{DerivedPartOfPerspectivesFKTS13BackingBean.searchTerm}" 
                 size="50"
                 maxlength="50" />
    <br />
    <br />
    ...
    <h:commandButton value="Search" 
                     action="#{DerivedPartOfPerspectivesFKTS13BackingBean.pageFirst}">
    </h:commandButton>
                         
    <%--<h:inputHidden binding="#{DerivedPartOfPerspectivesFKTS13BackingBean.text}" 
                   value="#{DerivedPartOfPerspectivesFKTS13BackingBean.textValue}">
      <f:attribute name="stage" value="12" />
    </h:inputHidden>--%>
    ...
    <h:dataTable value="#{DerivedPartOfPerspectivesFKTS13BackingBean.dataList}" 
                 var="item">
...
<h:outputText value="#{item.fullPathJson}" escape="false"/>
    ...
    <h:commandButton value="first" 
                     action="#{DerivedPartOfPerspectivesFKTS13BackingBean.pageFirst}"
                     disabled="#{DerivedPartOfPerspectivesFKTS13BackingBean.firstRow == 0}" />
                      
    <h:commandButton value="prev" 
                     action="#{DerivedPartOfPerspectivesFKTS13BackingBean.pagePrevious}"
                     disabled="#{DerivedPartOfPerspectivesFKTS13BackingBean.firstRow == 0}" />
    
    <h:commandButton value="next" 
                     action="#{DerivedPartOfPerspectivesFKTS13BackingBean.pageNext}"
                     disabled="#{DerivedPartOfPerspectivesFKTS13BackingBean.firstRow + DerivedPartOfPerspectivesFKTS13BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS13BackingBean.totalRows}" />
                     
    <h:commandButton value="last" 
                     action="#{DerivedPartOfPerspectivesFKTS13BackingBean.pageLast}"
                     disabled="#{DerivedPartOfPerspectivesFKTS13BackingBean.firstRow + DerivedPartOfPerspectivesFKTS13BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS13BackingBean.totalRows}" />
      
    <h:outputText value="Tree No. #{DerivedPartOfPerspectivesFKTS13BackingBean.currentPage} From #{DerivedPartOfPerspectivesFKTS13BackingBean.totalPages} Possible Tree Paths" />
    <br />

    <%-- Cache bean with data list, paging and sorting variables for next request --%>
    <%-- <t:saveState value="#{DerivedPartOfPerspectivesFKTS13BackingBean}" />--%>
