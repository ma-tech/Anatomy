...
<body>
  ...
  <h:form id="form">
    ...
    <h1>Anatomy - ANAD_PART_OF_PERSPECTIVES, with FOREIGN KEYS, at STAGE TS14 ONLY, JSON Tree Only</h1>
    ...
    <h:inputText id="searchTerm" 
                 value="#{DerivedPartOfPerspectivesFKTS14BackingBean.searchTerm}" 
                 size="50"
                 maxlength="50" />
    <br />
    <br />
    ...
    <h:commandButton value="Search" 
                     action="#{DerivedPartOfPerspectivesFKTS14BackingBean.pageFirst}">
    </h:commandButton>
                         
    <%--<h:inputHidden binding="#{DerivedPartOfPerspectivesFKTS14BackingBean.text}" 
                   value="#{DerivedPartOfPerspectivesFKTS14BackingBean.textValue}">
      <f:attribute name="stage" value="13" />
    </h:inputHidden>--%>
    ...
    <h:dataTable value="#{DerivedPartOfPerspectivesFKTS14BackingBean.dataList}" 
                 var="item">
...
<h:outputText value="#{item.fullPathJson}" escape="false"/>
    ...
    <h:commandButton value="first" 
                     action="#{DerivedPartOfPerspectivesFKTS14BackingBean.pageFirst}"
                     disabled="#{DerivedPartOfPerspectivesFKTS14BackingBean.firstRow == 0}" />
                      
    <h:commandButton value="prev" 
                     action="#{DerivedPartOfPerspectivesFKTS14BackingBean.pagePrevious}"
                     disabled="#{DerivedPartOfPerspectivesFKTS14BackingBean.firstRow == 0}" />
    
    <h:commandButton value="next" 
                     action="#{DerivedPartOfPerspectivesFKTS14BackingBean.pageNext}"
                     disabled="#{DerivedPartOfPerspectivesFKTS14BackingBean.firstRow + DerivedPartOfPerspectivesFKTS14BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS14BackingBean.totalRows}" />
                     
    <h:commandButton value="last" 
                     action="#{DerivedPartOfPerspectivesFKTS14BackingBean.pageLast}"
                     disabled="#{DerivedPartOfPerspectivesFKTS14BackingBean.firstRow + DerivedPartOfPerspectivesFKTS14BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS14BackingBean.totalRows}" />
      
    <h:outputText value="Tree No. #{DerivedPartOfPerspectivesFKTS14BackingBean.currentPage} From #{DerivedPartOfPerspectivesFKTS14BackingBean.totalPages} Possible Tree Paths" />
    <br />

    <%-- Cache bean with data list, paging and sorting variables for next request --%>
    <%-- <t:saveState value="#{DerivedPartOfPerspectivesFKTS14BackingBean}" />--%>
