...
<body>
  ...
  <h:form id="form">
    ...
    <h1>Anatomy - ANAD_PART_OF_PERSPECTIVES, with FOREIGN KEYS, at STAGE TS21 ONLY, JSON Tree Only</h1>
    ...
    <h:inputText id="searchTerm" 
                 value="#{DerivedPartOfPerspectivesFKTS21BackingBean.searchTerm}" 
                 size="50"
                 maxlength="50" />
    <br />
    <br />
    ...
    <h:commandButton value="Search" 
                     action="#{DerivedPartOfPerspectivesFKTS21BackingBean.pageFirst}">
    </h:commandButton>
                         
    <%--<h:inputHidden binding="#{DerivedPartOfPerspectivesFKTS21BackingBean.text}" 
                   value="#{DerivedPartOfPerspectivesFKTS21BackingBean.textValue}">
      <f:attribute name="stage" value="20" />
    </h:inputHidden>--%>
    ...
    <h:dataTable value="#{DerivedPartOfPerspectivesFKTS21BackingBean.dataList}" 
                 var="item">
...
<h:outputText value="#{item.fullPathJson}" escape="false"/>
    ...
    <h:commandButton value="first" 
                     action="#{DerivedPartOfPerspectivesFKTS21BackingBean.pageFirst}"
                     disabled="#{DerivedPartOfPerspectivesFKTS21BackingBean.firstRow == 0}" />
                      
    <h:commandButton value="prev" 
                     action="#{DerivedPartOfPerspectivesFKTS21BackingBean.pagePrevious}"
                     disabled="#{DerivedPartOfPerspectivesFKTS21BackingBean.firstRow == 0}" />
    
    <h:commandButton value="next" 
                     action="#{DerivedPartOfPerspectivesFKTS21BackingBean.pageNext}"
                     disabled="#{DerivedPartOfPerspectivesFKTS21BackingBean.firstRow + DerivedPartOfPerspectivesFKTS21BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS21BackingBean.totalRows}" />
                     
    <h:commandButton value="last" 
                     action="#{DerivedPartOfPerspectivesFKTS21BackingBean.pageLast}"
                     disabled="#{DerivedPartOfPerspectivesFKTS21BackingBean.firstRow + DerivedPartOfPerspectivesFKTS21BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS21BackingBean.totalRows}" />
      
    <h:outputText value="Tree No. #{DerivedPartOfPerspectivesFKTS21BackingBean.currentPage} From #{DerivedPartOfPerspectivesFKTS21BackingBean.totalPages} Possible Tree Paths" />
    <br />

    <%-- Cache bean with data list, paging and sorting variables for next request --%>
    <%-- <t:saveState value="#{DerivedPartOfPerspectivesFKTS21BackingBean}" /> --%>
