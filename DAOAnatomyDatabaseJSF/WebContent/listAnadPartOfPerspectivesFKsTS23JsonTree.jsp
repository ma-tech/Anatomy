...
<body>
  ...
  <h:form id="form">
    ...
    <h1>Anatomy - ANAD_PART_OF_PERSPECTIVES, with FOREIGN KEYS, at STAGE TS23 ONLY, JSON Tree Only</h1>
    ...
    <h:inputText id="searchTerm" 
                 value="#{DerivedPartOfPerspectivesFKTS23BackingBean.searchTerm}" 
                 size="50"
                 maxlength="50" />
    <br />
    <br />
    ...
    <h:commandButton value="Search" 
                     action="#{DerivedPartOfPerspectivesFKTS23BackingBean.pageFirst}">
    </h:commandButton>
                         
    <%--<h:inputHidden binding="#{DerivedPartOfPerspectivesFKTS23BackingBean.text}" 
                   value="#{DerivedPartOfPerspectivesFKTS23BackingBean.textValue}">
      <f:attribute name="stage" value="22" />
    </h:inputHidden>--%>
    ...
    <h:dataTable value="#{DerivedPartOfPerspectivesFKTS23BackingBean.dataList}" 
                 var="item">
...
<h:outputText value="#{item.fullPathJson}" escape="false"/>
    ...
    <h:commandButton value="first" 
                     action="#{DerivedPartOfPerspectivesFKTS23BackingBean.pageFirst}"
                     disabled="#{DerivedPartOfPerspectivesFKTS23BackingBean.firstRow == 0}" />
                      
    <h:commandButton value="prev" 
                     action="#{DerivedPartOfPerspectivesFKTS23BackingBean.pagePrevious}"
                     disabled="#{DerivedPartOfPerspectivesFKTS23BackingBean.firstRow == 0}" />
    
    <h:commandButton value="next" 
                     action="#{DerivedPartOfPerspectivesFKTS23BackingBean.pageNext}"
                     disabled="#{DerivedPartOfPerspectivesFKTS23BackingBean.firstRow + DerivedPartOfPerspectivesFKTS23BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS23BackingBean.totalRows}" />
                     
    <h:commandButton value="last" 
                     action="#{DerivedPartOfPerspectivesFKTS23BackingBean.pageLast}"
                     disabled="#{DerivedPartOfPerspectivesFKTS23BackingBean.firstRow + DerivedPartOfPerspectivesFKTS23BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS23BackingBean.totalRows}" />
      
    <h:outputText value="Tree No. #{DerivedPartOfPerspectivesFKTS23BackingBean.currentPage} From #{DerivedPartOfPerspectivesFKTS23BackingBean.totalPages} Possible Tree Paths" />
    <br />

    <%-- Cache bean with data list, paging and sorting variables for next request --%>
    <%-- <t:saveState value="#{DerivedPartOfPerspectivesFKTS23BackingBean}" /> --%>
