...
<body>
  ...
  <h:form id="form">
    ...
    <h1>Anatomy - ANAD_PART_OF_PERSPECTIVES, with FOREIGN KEYS, at STAGE TS28 ONLY, JSON Tree Only</h1>
    ...
    <h:inputText id="searchTerm" 
                 value="#{DerivedPartOfPerspectivesFKTS28BackingBean.searchTerm}" 
                 size="50"
                 maxlength="50" />
    <br />
    <br />
    ...
    <h:commandButton value="Search" 
                     action="#{DerivedPartOfPerspectivesFKTS28BackingBean.pageFirst}">
    </h:commandButton>
                         
    <%--<h:inputHidden binding="#{DerivedPartOfPerspectivesFKTS28BackingBean.text}" 
                   value="#{DerivedPartOfPerspectivesFKTS28BackingBean.textValue}">
      <f:attribute name="stage" value="27" />
    </h:inputHidden>--%>
    ...
    <h:dataTable value="#{DerivedPartOfPerspectivesFKTS28BackingBean.dataList}" 
                 var="item">
...
<h:outputText value="#{item.fullPathJson}" escape="false"/>
    ...
    <h:commandButton value="first" 
                     action="#{DerivedPartOfPerspectivesFKTS28BackingBean.pageFirst}"
                     disabled="#{DerivedPartOfPerspectivesFKTS28BackingBean.firstRow == 0}" />
                      
    <h:commandButton value="prev" 
                     action="#{DerivedPartOfPerspectivesFKTS28BackingBean.pagePrevious}"
                     disabled="#{DerivedPartOfPerspectivesFKTS28BackingBean.firstRow == 0}" />
    
    <h:commandButton value="next" 
                     action="#{DerivedPartOfPerspectivesFKTS28BackingBean.pageNext}"
                     disabled="#{DerivedPartOfPerspectivesFKTS28BackingBean.firstRow + DerivedPartOfPerspectivesFKTS28BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS28BackingBean.totalRows}" />
                     
    <h:commandButton value="last" 
                     action="#{DerivedPartOfPerspectivesFKTS28BackingBean.pageLast}"
                     disabled="#{DerivedPartOfPerspectivesFKTS28BackingBean.firstRow + DerivedPartOfPerspectivesFKTS28BackingBean.rowsPerPage >= DerivedPartOfPerspectivesFKTS28BackingBean.totalRows}" />
      
    <h:outputText value="Tree No. #{DerivedPartOfPerspectivesFKTS28BackingBean.currentPage} From #{DerivedPartOfPerspectivesFKTS28BackingBean.totalPages} Possible Tree Paths" />
    <br />

    <%-- Cache bean with data list, paging and sorting variables for next request --%>
    <%-- <t:saveState value="#{DerivedPartOfPerspectivesFKTS28BackingBean}" /> --%>
