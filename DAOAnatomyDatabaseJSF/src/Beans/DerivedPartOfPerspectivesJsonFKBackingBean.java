...
import DAOLayer.DerivedPartOfPerspectivesJsonFKDAO;
import DAOLayer.DAOException;

import Model.DerivedPartOfPerspectivesJsonFK;
 ...
 */
public class DerivedPartOfPerspectivesJsonFKBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------

    // DAO.
    private static DerivedPartOfPerspectivesJsonFKDAO dao = Config.getInstance().getDAOFactory().getDerivedPartOfPerspectivesJsonFKDAO();

    // Data.
    private List<DerivedPartOfPerspectivesJsonFK> dataList;
    ...
    // Constructors -------------------------------------------------------------------------------
    public DerivedPartOfPerspectivesJsonFKBackingBean() {
    ...
    private void loadDataList() {
        ...
        try {
            dataList = dao.display(firstRow, rowsPerPage, sortField, sortAscending, searchTerm, searchPerspective);
            totalRows = dao.count(searchTerm, searchPerspective);
        } 
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<DerivedPartOfPerspectivesJsonFK> getDataList() {
        if (dataList == null) {
