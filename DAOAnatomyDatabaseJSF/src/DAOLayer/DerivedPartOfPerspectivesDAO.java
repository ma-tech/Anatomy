    ...
    public int count(String searchTerm, String searchPerspective) throws DAOException {
        ...
        if (searchTerm.equals("")){
            try {
                ...
                preparedStatement = prepareStatement(connection, SQL_ROW_COUNT_BY_PERSPECTIVE, false, values);
            ...
            try {
                ...
                preparedStatement = prepareStatement(connection, SQL_ROW_COUNT_BY_PERSPECTIVE_AND, false, values);
