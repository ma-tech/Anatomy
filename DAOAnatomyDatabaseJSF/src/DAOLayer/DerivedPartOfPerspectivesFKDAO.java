    ...
    public int count(String searchTerm, String searchId, String searchDirection, String searchStartStage, String searchEndStage, String searchPerspective) throws DAOException {
        ...
        if (searchTerm.equals("") && searchId.equals("")){
            ...
            try {
                ...
                preparedStatement = prepareStatement(connection, SQL_ROW_COUNT_WHERE_BY_PERSPECTIVE, false, values);
        ...
        if (searchTerm.equals("") && !searchId.equals("")) {
        	...
        	try {
                ...
                preparedStatement = prepareStatement(connection, SQL_ROW_COUNT_WHERE_BY_PERSPECTIVE_AND_ID, false, values);
        ...
        if (!searchTerm.equals("") && searchId.equals("")){
            ...
            try {
                ...
                preparedStatement = prepareStatement(connection, SQL_ROW_COUNT_WHERE_BY_PERSPECTIVE_AND_PATH, false, values);
        ...
        if (!searchTerm.equals("") && !searchId.equals("")) {
        	...
        	try {
                ...
                preparedStatement = prepareStatement(connection, SQL_ROW_COUNT_WHERE_BY_PERSPECTIVE_AND_PATH_AND_ID, false, values);
