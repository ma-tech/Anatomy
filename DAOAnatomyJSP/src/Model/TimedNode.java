...
public class TimedNode implements Serializable {
    ...
    public String toString() {
        return String.format("TimedNode [ oid=%d, nodeFK=%d, stageFK=%d, stageModifierFK=%s, publicEmapId=%s, publicEmapaId=%s, stageName=%s, stageSeq=%d, stageMaxName=%s, stageMaxName=%s ]", 
