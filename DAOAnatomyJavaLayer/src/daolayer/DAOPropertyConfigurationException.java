...
public class DAOPropertyConfigurationException extends RuntimeException {
    // Constructors -------------------------------------------------------------------------------
    /*
     * Constructs a DAOConfigurationException with the given detail message.
     */
    public DAOPropertyConfigurationException(String message) {
     ...
     */
    public DAOPropertyConfigurationException(Throwable cause) {
     ...
     */
    public DAOPropertyConfigurationException(String message, Throwable cause) {
