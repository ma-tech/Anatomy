...
public class AnaNode {
    ...
    public boolean insertANA_NODE( ArrayList<OBOComponent> newTermList,
    ...
    //  Insert new rows into ANA_NODE
    public boolean deleteANA_NODE( ArrayList<OBOComponent> termList, 
    		String strSpecies, 
    ...
    public boolean updateANA_NODE_name( ArrayList<OBOComponent> changedNameTermList, 
    		String calledFrom, 
    ...
    public boolean updateANA_NODE_primary( ArrayList< OBOComponent > changedPrimaryTermList, 
    		String calledFrom, 
    		String strSpecies ) throws Exception  {
    ...
    //  Update ANA_NODE for Changed Names
    public boolean logANA_NODE( Node node, 
    		String calledFrom, 
    		String strSpecies ) throws Exception  {
