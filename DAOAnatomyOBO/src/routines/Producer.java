                ...
                if ( !obocomponentList.get(i).getStatusChange().equals("DELETED") ){
                    ...
                    if ( !obocomponentList.get(i).getNamespace().equals("theiler_stage") ||
                        ...
                        for (int j=0; j<obocomponentList.get(i).getChildOfs().size(); j++) {
                        	...
                        	if (obocomponentList.get(i).getChildOfTypes().get(j).equals("LOCATED_IN")) {
                                outputFile.write("relationship: located_in " +
                                		obocomponentList.get(i).getChildOfs().get(j) + "\n");
                            }
                        	if (obocomponentList.get(i).getChildOfTypes().get(j).equals("DEVELOPS_IN")) {
                                outputFile.write("relationship: develops_in " +
                                		obocomponentList.get(i).getChildOfs().get(j) + "\n");
                            }
                        	if (obocomponentList.get(i).getChildOfTypes().get(j).equals("HAS_PART")) {
                        	...
                        	if (obocomponentList.get(i).getChildOfTypes().get(j).equals("DISJOINT_FROM")) {
