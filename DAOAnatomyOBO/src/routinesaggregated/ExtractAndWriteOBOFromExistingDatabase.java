    ...
    public static void run(DAOFactory daofactory, OBOFactory obofactory) throws Exception {
        ...
        if ( componentOBO.writeAll( "Abstract" ) ) {
        	if ( obofactory.getComponentOBO().debug() ) {
                System.out.println("Obo File SUCCESSFULLY written to " + newFileName + " for Species " + obofactory.getComponentOBO().species() + " and Project " + obofactory.getComponentOBO().project());
        	}
        }
        else {
        	if ( obofactory.getComponentOBO().debug() ) {
                System.out.println("Obo File FAILED written to " + newFileName + " for Species " + obofactory.getComponentOBO().species() + " and Project " + obofactory.getComponentOBO().project());
        	}
        }
