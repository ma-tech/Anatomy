...
public class GenerateEditorPDF {
	...
	public GenerateEditorPDF(
        ...
        if (this.debug) {
            ...
            System.out.println("=================");
            System.out.println("GenerateEditorPDF - Constructor");
            System.out.println("=================");
        }
    ...
    private void writeSummaryTable( ValidateComponents validatecomponents ){
        ...
        if (this.debug) {
            ...
            System.out.println("writeSummaryTable");
        }
    ...
    private Cell makeSummaryTableLabel(String label){
        ...
        if (this.debug) {
            ...
            System.out.println("makeSummaryTableLabel");
        }
    ...
    private Cell makeSummaryTableEntry(String entry, int style, Color color){
        ...
        if (this.debug) {
            ...
            System.out.println("makeSummaryTableEntry");
        }
    ...
    private void addSummaryEntry( String label, String item,
        ...
        if (this.debug) {
            ...
            System.out.println("addSummaryEntry");
        }
    ...
    private void makeComponentTable( OBOComponent obocomponent, String tableHeader, int counter, Color tableColor ){
        ...
        if (this.debug) {
            ...
            System.out.println("makeComponentTable");
        }
