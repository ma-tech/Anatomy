...
public class GenerateEditorReport {
    ...
    //----------------------------------------------------------------------------------------------
    // Constructor ---------------------------------------------------------------------------------
	public GenerateEditorReport( Boolean debug, ValidateComponents validatecomponents, String infile, String outfile ){
        ...
        if (this.debug) {
            ...
            System.out.println("====================");
            System.out.println("GenerateEditorReport - Constructor");
            System.out.println("====================");
        }
    ...
    private void sortChangedTerms(ArrayList<OBOComponent> obocomponents){
        ...
        if (this.debug) {
            ...
            System.out.println("sortChangedTerms");
        }
    ...
    private void writeReportSummary(ValidateComponents validatecomponent){
        ...
        if (this.debug) {
            ...
            System.out.println("writeReportSummary");
        }
	...
	private void writeProblemTerms(ArrayList<OBOComponent> obocomponents){
        ...
        if (this.debug) {
            ...
            System.out.println("writeProblemTerms");
        }
	...
	private void writeNewTerms(ArrayList<OBOComponent> obocomponents){
        ...
        if (this.debug) {
            ...
            System.out.println("writeNewTerms");
        }
	...
	private void writeModifiedTerms(ArrayList<OBOComponent> obocomponents){
        ...
        if (this.debug) {
            ...
            System.out.println("writeModifiedTerms");
        }
    ...
    private void writeDeletedTerms(ArrayList<OBOComponent> obocomponents){
        ...
        if (this.debug) {
            ...
            System.out.println("writeDeletedTerms");
        }
    ...
    private void flushStringWriter(){
        ...
        if (this.debug) {
            ...
            System.out.println("flushStringWriter");
        }
    ...
    private void writeAppendix(){  
        ...
        if (this.debug) {
            ...
            System.out.println("writeAppendix");
        }
