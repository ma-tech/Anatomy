...
import routinesaggregated.ValidateComponentsTablesAgainstExistingDatabase;
...
public class MainValidateComponentsTablesAgainstExistingDatabase{
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("=========   ---------------------------------------------------");
        System.out.println("EXECUTING - MainValidateComponentsTablesAgainstExistingDatabase.java on " + parsed.toString());
        System.out.println("=========   ---------------------------------------------------");
        System.out.println("");
        /*
         * MAINLINE
        ...
        System.out.println("");
        System.out.println("=========   ---------------------------------------------------");
        System.out.println("DONE      - MainValidateComponentsTablesAgainstExistingDatabase.java took " + duration / 1000 + " seconds");
        System.out.println("=========   ---------------------------------------------------");
    }
}
