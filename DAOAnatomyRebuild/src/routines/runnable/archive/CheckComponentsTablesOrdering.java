...
public class CheckComponentsTablesOrdering {
	...
	public static void run( DAOFactory daofactory, OBOFactory obofactory) throws Exception {
	    ...
	    Wrapper.printMessage("checkcomponentstablesordering.run", "***", daofactory.getMsgLevel());
        ...
        while (iteratorSpecialComponentOrder.hasNext()) {
        	...
        	if ( newParentId.equals(oldParentId) ) {
        		...
        		if ( newCount != newParentCount ) {
        		    ...
        		    Wrapper.printMessage("checkcomponentstablesordering.run : Parent " + componentorder.getParent() + " Child " + componentorder.getChild() + " Special Order(" + ObjectConverter.convert(componentorder.getSpecialorder(), String.class) + ") NOT EQUAL to expected (" + ObjectConverter.convert(newCount, String.class) + ")", "***", daofactory.getMsgLevel());
        			errorCount++;
        		}
        	}
        	else {
	    ...
	    Wrapper.printMessage("checkcomponentstablesordering.run : ----------------------------", "***", daofactory.getMsgLevel());
	    Wrapper.printMessage("checkcomponentstablesordering.run : Special Order Error Count    = " + ObjectConverter.convert(errorCount, String.class), "***", daofactory.getMsgLevel());
	    Wrapper.printMessage("checkcomponentstablesordering.run : ----------------------------", "***", daofactory.getMsgLevel());
        ...
        while (iteratorAlphaComponentOrder.hasNext()) {
        	...
        	if ( newParentId.equals(oldParentId) ) {
        		...
        		if ( newCount != newParentCount ) {
        		    ...
        		    Wrapper.printMessage("checkcomponentstablesordering.run : Parent " + componentorder.getParent() + " Child " + componentorder.getChild() + " Alpha Order(" + ObjectConverter.convert(componentorder.getAlphaorder(), String.class) + ") NOT EQUAL to expected (" + ObjectConverter.convert(newCount, String.class) + ")", "***", daofactory.getMsgLevel());
        		    errorCount++;
        		}
        	}
        	else {
	    ...
	    Wrapper.printMessage("checkcomponentstablesordering.run : ----------------------------", "***", daofactory.getMsgLevel());
	    Wrapper.printMessage("checkcomponentstablesordering.run : Alphabetic Order Error Count = " + ObjectConverter.convert(errorCount, String.class), "***", daofactory.getMsgLevel());
	    Wrapper.printMessage("checkcomponentstablesordering.run : ----------------------------", "***", daofactory.getMsgLevel());
    }
}
