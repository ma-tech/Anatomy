...
public class TextServlet extends HttpServlet {
        ...
        throws ServletException, IOException
    {
        ...
        try {
            ...
            response.setContentType(obofile.getTextreporttype());
            response.setHeader("Content-Length", String.valueOf(obofile.getTextreportlength()));
            response.setHeader("Content-Disposition", "attachment; filename=\"" + obofile.getTextreportname() + "\"");
            ...
            // Open streams.
            input = new BufferedInputStream(obofile.getTextreport(), DEFAULT_BUFFER_SIZE);
