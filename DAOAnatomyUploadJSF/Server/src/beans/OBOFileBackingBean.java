...
public class OBOFileBackingBean implements Serializable {
    ...
    // DAO.
    private static OBOFileDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(OBOFileDAO.class);
    ...
    public void validate(ActionEvent event) throws Exception {
        ...
        try {
            ...
            String argument2 = "AnatomyLoad.jar";
            String argument3 =  oidString;
            String argument4 = "mouse011Localhost"; 
            String argument5 = "mouse011OBOfile";
            
            //Wrapper.printMessage("process   = " + process, "*", "*");
            //Wrapper.printMessage("argument1 = " + argument1, "*", "*");
            //Wrapper.printMessage("argument2 = " + argument2, "*", "*");
            //Wrapper.printMessage("argument3 = " + argument3, "*", "*");
            //Wrapper.printMessage("argument4 = " + argument4, "*", "*");
            //Wrapper.printMessage("argument5 = " + argument5, "*", "*");

            ProcessBuilder pb = new ProcessBuilder(process, argument1, argument2, argument3, argument4, argument5);
            // My Mac Laptop
            String webInfLib = "/wtpwebapps/DAOAnatomyUploadJSF/WEB-INF/lib";
            // Caperdonich
            //String webInfLib = "/webapps/DAOAnatomyUploadJSF/WEB-INF/lib";
            String catalinaBase = System.getProperty("catalina.base");
            String directory = catalinaBase + webInfLib;

            //Wrapper.printMessage("webInfLib    = " + webInfLib, "*", "*");
            //Wrapper.printMessage("catalinaBase = " + catalinaBase, "*", "*");
            //Wrapper.printMessage("directory    = " + directory, "*", "*");
    ...
    public void update(ActionEvent event) throws Exception {
        ...
        try {
            ...
            //String process = "/opt/java6/bin/java";
            String argument1 =  "-jar";
            String argument2 =  "AnatomyUpdate.jar";
            String argument3 =  oidString;
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<OBOFile> getDataList() throws Exception {
        if (dataList == null) {
