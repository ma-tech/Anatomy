...
public final class UserForm extends Form {
     ...
     * this form.
     */
    public User registerUser(HttpServletRequest request) throws IllegalArgumentException, Exception {
     ...
     */
    public void processUsername(HttpServletRequest request, User user) throws Exception {
     ...
     */
    public void processEmail(HttpServletRequest request, User user) throws Exception {
