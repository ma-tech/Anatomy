...
--
-- Host: localhost    Database: anatomy009
-- ------------------------------------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=1022236 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ANAM_EDGE` (
  ...
  PRIMARY KEY (`AME_OID`)
) ENGINE=MyISAM AUTO_INCREMENT=67666 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=221408 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ANA_LOG` (
  ...
  PRIMARY KEY (`LOG_OID`),
  UNIQUE KEY `ALOG_LOGGED_OID_INDEX` (`LOG_LOGGED_OID`,`LOG_VERSION_FK`,`LOG_COLUMN_NAME`),
...
CREATE TABLE `ANA_OBJECT` (
  ...
  `OBJ_DESCRIPTION` varchar(255) NOT NULL DEFAULT '',
...
) ENGINE=MyISAM AUTO_INCREMENT=269653 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=18565 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=296969 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ANA_SYNONYM` (
  ...
  PRIMARY KEY (`SYN_OID`),
  -- sUNIQUE KEY `SYN_AK_INDEX` (`SYN_OBJECT_FK`,`SYN_SYNONYM`),
...
) ENGINE=MyISAM AUTO_INCREMENT=33978 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `TMP_ALL`
--
...
--
-- Table structure for table `TMP_DEVELOPS`
--

DROP TABLE IF EXISTS `TMP_DEVELOPS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TMP_DEVELOPS` (
  `ACR_OBO_ID` varchar(25) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE TABLE `anav_grand_relation` (
  `ANAV_ID_1` varchar(64),
  `ANAV_NAME_1` varchar(20),
  `ANAV_DESC_1` varchar(255),
  `ANAV_STG_MIN_1` varchar(64),
  `ANAV_STG_MAX_1` varchar(64),
  `ANAV_OID_2` int(11),
  `ANAV_ID_2` varchar(64),
  `ANAV_NAME_2` varchar(20),
  `ANAV_DESC_2` varchar(255),
  `ANAV_STG_MIN_2` varchar(64),
  `ANAV_STG_MAX_2` varchar(64),
  `ANAV_ID_3` varchar(64),
  `ANAV_NAME_3` varchar(20),
  `ANAV_DESC_3` varchar(255),
  `ANAV_STG_MIN_3` varchar(64),
  `ANAV_STG_MAX_3` varchar(64)
) ENGINE=MyISAM */;
...
/*!50001 CREATE TABLE `anav_leaf_relation` (
  `ANAV_OID_1` int(10) unsigned,
  `ANAV_NAME_1` varchar(20),
  `ANAV_DESC_1` varchar(255),
  `ANAV_MIN_1` int(10) unsigned,
  `ANAV_MAX_1` int(10) unsigned,
  `ANAV_OID_2` int(10) unsigned,
  `ANAV_NAME_2` varchar(20),
  `ANAV_DESC_2` varchar(255),
  `ANAV_MIN_2` int(10) unsigned,
  `ANAV_MAX_2` int(10) unsigned
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `anav_relation` (
  `ANAV_OID` int(11),
  `ANAV_ENTRY_EDGE_ID` int(11),
  `ANAV_DIRECT_EDGE_ID` int(11),
  `ANAV_EXIT_EDGE_ID` int(11),
  `ANAV_CHILD_ID` varchar(64),
  `ANAV_CHILD_NAME` varchar(20),
  `ANAV_CHILD_DESC` varchar(255),
  `ANAV_CHILD_STG_MIN` varchar(64),
  `ANAV_CHILD_STG_MAX` varchar(64),
  `ANAV_PARENT_ID` varchar(64),
  `ANAV_PARENT_NAME` varchar(20),
  `ANAV_PARENT_DESC` varchar(255),
  `ANAV_PARENT_STG_MIN` varchar(64),
  `ANAV_PARENT_STG_MAX` varchar(64),
  `ANAV_HOPS` int(11),
  `ANAV_SOURCE` varchar(64)
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `anav_relationship_timed` (
  `ANAV_REL_OID` int(10) unsigned,
  `ANAV_REL_RELATIONSHIP_TYPE_FK` varchar(20),
  `ANAV_REL_CHILD_FK` int(10) unsigned,
  `ANAV_REL_PARENT_FK` int(10) unsigned,
  `ANAV_REL_STAGE` int(10) unsigned
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `anav_stage_range` (
  `ANAV_NODE_FK` int(10) unsigned,
  `ANAV_STAGE_MIN` int(10) unsigned,
  `ANAV_STAGE_MAX` int(10) unsigned
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `anav_timed_relation` (
  `ANAV_T_OID` int(11),
  `ANAV_T_ENTRY_EDGE_ID` int(11),
  `ANAV_T_DIRECT_EDGE_ID` int(11),
  `ANAV_T_EXIT_EDGE_ID` int(11),
  `ANAV_T_STAGE` varchar(64),
  `ANAV_T_CHILD_ID` varchar(64),
  `ANAV_T_CHILD_NAME` varchar(20),
  `ANAV_T_CHILD_DESC` varchar(255),
  `ANAV_T_PARENT_ID` varchar(64),
  `ANAV_T_PARENT_NAME` varchar(20),
  `ANAV_T_PARENT_DESC` varchar(255),
  `ANAV_T_HOPS` int(11),
  `ANAV_T_SOURCE` varchar(64)
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Dumping routines for database 'anatomy009'
--
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `ANASP_ADD_EDGE`( IN childnodeid VARCHAR(100),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `ANASP_ADD_TIMED_EDGE`( IN childnodeid VARCHAR(100),
                                 IN parentnodeid VARCHAR(100),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `ANASP_REMOVE_EDGE`( IN edgeid INT )
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `ANASP_REMOVE_TIMED_EDGE`( IN edgeid INT )
BEGIN
  DECLARE rows INT DEFAULT 0;
...
-- Dump completed on 2012-07-17 15:57:06
