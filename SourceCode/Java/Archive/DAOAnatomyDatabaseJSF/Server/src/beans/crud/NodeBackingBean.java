 ...
 */
public class NodeBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------

    // DAO.
    private static NodeDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(NodeDAO.class);
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<Node> getDataList() throws Exception {
        if (dataList == null) {
