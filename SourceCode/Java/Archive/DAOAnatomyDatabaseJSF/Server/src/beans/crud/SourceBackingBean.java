 ...
 */
public class SourceBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------

    // DAO.
    private static SourceDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(SourceDAO.class);
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<Source> getDataList() throws Exception {
        if (dataList == null) {
