 ...
 */
public class TimedNodeBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------

    // DAO.
    private static ExtraTimedNodeDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(ExtraTimedNodeDAO.class);
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<ExtraTimedNode> getDataList() throws Exception {
        if (dataList == null) {
