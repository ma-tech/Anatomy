 ...
 */
public class DerivedPartOfFKBackingBean implements Serializable {

    // Properties ---------------------------------------------------------------------------------

    // DAO.
    private static DerivedPartOfFKDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(DerivedPartOfFKDAO.class);

    // Data.
    private List<DerivedPartOfFK> dataList;
    ...
    // Constructors -------------------------------------------------------------------------------
    public DerivedPartOfFKBackingBean() {
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<DerivedPartOfFK> getDataList() throws Exception {
        if (dataList == null) {
