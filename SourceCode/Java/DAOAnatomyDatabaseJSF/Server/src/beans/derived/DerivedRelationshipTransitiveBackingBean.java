...
public class DerivedRelationshipTransitiveBackingBean implements Serializable {
    ...
    // DAO.
    private static DerivedRelationshipTransitiveDAO dao = Config.getInstance().getDAOFactory().getDAOImpl(DerivedRelationshipTransitiveDAO.class);
    ...
    // Getters ------------------------------------------------------------------------------------
    public List<DerivedRelationshipTransitive> getDataList() throws Exception {
        if (dataList == null) {
