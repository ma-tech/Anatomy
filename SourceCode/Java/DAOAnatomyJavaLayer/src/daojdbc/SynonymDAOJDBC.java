    ...
    public void create(Synonym synonym) throws IllegalArgumentException, Exception {
        ...
        try {
            ...
            if ( daoFactory.isUpdate() ) {
    		    ...
    		    Wrapper.printMessage("UPDATE: Create ANA_SYNONYM Skipped", "***", daoFactory.getMsgLevel());
            }
        } 
        catch (SQLException e) {
    ...
    public void update(Synonym synonym) throws Exception {
        ...
        try {
            ...
            if ( daoFactory.isUpdate() ) {
    		    ...
    		    Wrapper.printMessage("UPDATE: Update ANA_SYNONYM Skipped", "***", daoFactory.getMsgLevel());
            }
        } 
        catch (SQLException e) {
    ...
    public void delete(Synonym synonym) throws Exception {
        ...
        try {
            ...
            if ( daoFactory.isUpdate() ) {
    		    ...
    		    Wrapper.printMessage("UPDATE: Delete ANA_SYNONYM Skipped", "***", daoFactory.getMsgLevel());
            }
        } 
        catch (SQLException e) {
