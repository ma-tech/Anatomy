...
import routines.runnable.UpdateDatabaseWithGroups;


public class Main3UpdateDatabaseWithGroups{
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 5 ) {
            ...
            UpdateDatabaseWithGroups.run( daofactory, obofactory, args[4], separator );
        }
