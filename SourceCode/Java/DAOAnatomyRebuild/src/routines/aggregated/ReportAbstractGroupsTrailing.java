...
public class ReportAbstractGroupsTrailing {
	...
	public static void run( OBOFactory obofactory, DAOFactory daofactory, String perspective, String filePath ) throws Exception {
	    ...
	    Wrapper.printMessage("ReportAbstractGroupsTrailing.run", "***", daofactory.getMsgLevel());
	    
        File fileReportAbstractGroupsTrailing = new File(filePath + "/Abstract/AbstractGroupsTrailing.txt");
	    ...
	    if ( VALID_PERSPECTIVES.contains( perspective ) ) {
		    ...
		    record = "";
		    recordsList.add(record);
		    record = "Abstract " + perspective + " Excluding Groups";
		    recordsList.add(record);
		    record = "";
		    recordsList.add(record);
		    ...
		    Iterator<DerivedPartOfFK> iteratorDerivedPartOfFK = derivedpartoffks.iterator();
	      	...
	      	while (iteratorDerivedPartOfFK.hasNext()) {
	      		...
	      		if ( derivedpartofperspectives != null ) {
		      		...
		      		if ( derivedpartoffk.isPrimary() && derivedpartoffk.isPrimaryPath()) {
		    ...
		    record = "";
		    recordsList.add(record);
		    record = "Abstract " + perspective + " Showing Only Groups  =====";
		    recordsList.add(record);
		    record = "";
		    recordsList.add(record);
		    record = "";
		    ...
		    derivedpartoffks = (ArrayList<DerivedPartOfFK>) derivedpartoffkDAO.display(0, 30000, "fullPath", true, "");

		    iteratorDerivedPartOfFK = derivedpartoffks.iterator();
        ...
        FileUtil.write(fileReportAbstractGroupsTrailing, recordsList);
	}
}
