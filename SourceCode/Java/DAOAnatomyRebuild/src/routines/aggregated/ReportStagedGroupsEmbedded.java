...
public class ReportStagedGroupsEmbedded {
	...
	public static void run( OBOFactory obofactory, DAOFactory daofactory, String perspective, String filePath ) throws Exception {
	    ...
	    Wrapper.printMessage("ReportStagedGroupsEmbedded.run", "***", daofactory.getMsgLevel());
	    
	    List<String> recordsListAll = new ArrayList<String>();

	    if ( VALID_PERSPECTIVES.contains( perspective ) ) {
	    	
		    File fileReportAllStagesGroupsEmbedded = new File( filePath + "/ByStage/GroupsEmbedded/AllStagesGroupsEmbedded.txt");
		    ...
		    Iterator<Stage> iteratorStage = stages.iterator();
	      	...
	      	while (iteratorStage.hasNext()) {
			    ...
			    File fileReportStagedGroupsEmbedded = new File( filePath + "/ByStage/GroupsEmbedded/" + stage.getName() + "GroupsEmbedded.txt");
			    ...
			    FileUtil.write(fileReportStagedGroupsEmbedded, recordsList);
		    ...
		    FileUtil.write(fileReportAllStagesGroupsEmbedded, recordsListAll);
	    }
	    else { 
