...
from hgu.anatomyDb.version011 import AnaRelationshipDb
...
DISPLAY_ID_COLUMN          = "ATN_DISPLAY_ID"
...
class AnaTimedNodeDbRecord:
    ...
    def getDisplayId(self):
        """
        Return the display ID for this timed node, e.g., EMAP:0012345.
        """
        return self.getDbRecord().getColumnValue(DISPLAY_ID_COLUMN)

    def setDisplayId(self, displayId):
        """
        Set the display ID for this timed node, e.g., EMAP:0012345.
        """
        return self.getDbRecord().setColumnValue(DISPLAY_ID_COLUMN, displayId)
...
_table.registerColumn(DISPLAY_ID_COLUMN,           DbTable.IS_NOT_KEY)
